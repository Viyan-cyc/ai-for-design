...
console.log(`  from views/${slug}/components|js: ../../../api/${slug}.js | ../../../locales/pages/${slug}.js | ../../../assets/icons/index.js | ../js/constants.js`);
console.log(`  from src/components/**.vue:       ../api/${slug}.js | ../locales/pages/${slug}.js | ../assets/icons/index.js`);
console.log('  (icons barrel index.js is generated by fetch_icons.mjs; until then import .svg files directly — ../../assets/icons/xxx.svg from views/{slug}/, ../../../ from views/{slug}/components|js)');
process.exit(0);
